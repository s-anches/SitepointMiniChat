set :application, 'SitepointMiniChat'
set :repo_url, 'git@github.com:s-anches/SitepointMiniChat.git'

application = 'SitepointMiniChat'
set :rvm_type, :user
set :rvm_ruby_version, '2.2.1'
set :deploy_to, '/var/www/apps/SitepointMiniChat'
